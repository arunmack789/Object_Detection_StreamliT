...
def obj_detection(my_img):
    ...
    # YOLO model
    net = cv2.dnn.readNet("C://Users//lenovo//Documents//Downloads//yolov3.weights", "C://Users//lenovo//Documents//Downloads//yolov3.cfg")
...
def main():
    ...
    if choice == "Choose an image of your choice":
        ...
        my_img = Image.open("C://Users//lenovo//Documents//Downloads//img1.jpg")
        obj_detection(my_img)
